create table tb_sales (id bigint not null auto_increment, amount double precision not null, date date, deals integer not null, visited integer not null, seller_id bigint, primary key (id)) engine=InnoDB;
